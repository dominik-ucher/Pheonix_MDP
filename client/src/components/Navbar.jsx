...
export default function DefaultNavbar() {
  ...
  return (
    ...
    <header className="top-0 w-full z-50 shadow-md bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900">
      <nav ref={sidebarRef}>
        {/* Navbar container */}
        <div className="flex justify-between items-center px-6 py-4">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button pill onClick={() => navigate('/speech_to_text')} className="bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 text-white hover:from-yellow-500 hover:via-red-600 hover:to-pink-600">Register with AI</Button></>)}
          </div>
