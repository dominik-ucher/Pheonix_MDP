...
export default function UserProfile() {
  ...
  <p className="text-black-500 text-sm mt-1">Click the microphone to dictate text.</p>
        ...
        <button className="mt-2 px-4 py-2 bg-red-700 text-white font-semibold rounded-md shadow-md hover:bg-gray-600 w-full text-lg font-bold" onClick={() => navigate('/')}>Back to Homepage</button>
